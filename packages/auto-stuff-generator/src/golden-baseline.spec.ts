...
// Self-owned deterministic fixture (generated by scripts/generate-golden-baseline.ts);
// the matrix-coverage and hash assertions below fail loudly if its shape drifts.
